...
class SearchFilterDB {

    public static function apply(Request $filters, $db, $fetchType = 'pageination'){
        $query = static::applyDecoratorsFromRequest($filters, $db);
    ...
    private static function applyDecoratorsFromRequest(Request $request, DB $query){
